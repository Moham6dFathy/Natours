...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYW02ZGZhdGh5IiwiYSI6ImNtMHdza25yaDA2NnEyaXF2NDN6ZGI2NzYifQ.z88BUzMTijsyBs4dSJdC-Q';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/moham6dfathy/cm0yurufm018301pjcl0oauoz',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Loging Out fail ! Try again.');
        case 10:
        case "end":
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = (0, _stripeJs.loadStripe)('pk_test_51Q1nauCQBLWpKgeplmR3WycD3CWWuw5qIz611n8PAT4mxKt6y9OF7Dz3accorXcu13L1xWmnvEnPOqCpqs5OiSka00ocBf4c4k');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(session);
          if (session.data.session.status === 'open') {
            window.open("".concat(session.data.session.url), '_blank');
          }
          _context.next = 12;
          break;
        case 8:
